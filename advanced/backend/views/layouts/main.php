...
<div class="leftpanel">
    ...
    <div class="leftpanel-userinfo collapse" id="loguserinfo">
        ...
        <address>天津市津南区南开大学计控学院</address>
        <h5 class="sidebar-title">联系方式</h5>
        <ul class="list-group">
            <li class="list-group-item">
                <label class="pull-left">邮箱</label>
                <span class="pull-right">13347629779@163.com</span>
            </li>
            <li class="list-group-item">
                <label class="pull-left">手机</label>
                <span class="pull-right">13347629779</span>
            </li>
            <li class="list-group-item">
...
<script type="text/javascript">
  $(".fa-angle-down").click(
      function(){
          if($("#loguserinfo").style.display==="block")
             $("#loguserinfo").style.display="none"；          
      }
  )
</script>
