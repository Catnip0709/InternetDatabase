 ...
 * @property Commentator $competitionCCTV5
...
class Competition extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Competition_CCTV5'], 'exist', 'skipOnError' => true, 'targetClass' => Commentator::className(), 'targetAttribute' => ['Competition_CCTV5' => 'commentator_Name']],
    ...
    {
        return $this->hasOne(Commentator::className(), ['commentator_Name' => 'Competition_CCTV5']);
    }
